...
**Προτείνεται η εγκατάσταση μέσα από το Microsoft Store.**

![Εικόνα 18](images/img18.png)

Μετά την εγκατάσταση θα σας ζητηθεί να δημιουργήσετε λογαριασμό στην υπηρεσία. Δεν είναι υποχρεωτικό, και μπορείτε να επιλέξετε skip.
...
Αν είναι η πρώτη φορά που χρησιμοποιήσετε το Docker Desktop, θα σας καθοδηγήσει να ενεργοποιήσετε το WSL 2.

Σιγουρευτείτε ότι το **WSL 2** είναι επιλεγμένο ως backend στο Docker Desktop. Για να το ελέγξετε, επιλέγετε το **Settings** (Ρυθμίσεις) του Docker και, στη συνέχεια, την καρτέλα **General** Η επιλογή **Use the WSL 2 based engine** θα πρέπει να είναι ενεργοποιημένη.

![Εικόνα 21](images/img21.png)

**Επιλογή διανομής WSL για Docker**: Στην καρτέλα **Resources** (υπο-καρτέλα **WSL integration**) του Docker Desktop, μπορείς να δεις ποιες διανομές Linux του WSL είναι διαθέσιμες για χρήση με το Docker. Βεβαιώσου ότι έχεις επιλέξει την διανομή Ubuntu (ή άλλη που έχεις εγκαταστήσει) για χρήση με το Docker.

![Εικόνα 12](images/img12.png)

**Επανεκκίνηση του Docker**: Αν γίνουν αλλαγές στις ρυθμίσεις, θα πρέπει να επανεκκινήσει το Docker Desktop για να εφαρμόσουν οι αλλαγές.

**Επιβεβαίωση Εγκατάστασης**

Από το **ubuntu**** ****terminal** και εκτελέστε την εντολή:
...
Αυτό θα πρέπει να εμφανίσει την έκδοση του Docker που έχει εγκατασταθεί.
...
**Αναβάθμιση Docker**: Το Docker Desktop ενημερώνεται αυτόματα. Μπορείτε να ελέγξετε αν υπάρχουν νέες εκδόσεις στις **Settings** > **Updates**.

**Ρυθμίσεις πόρων**: Στην καρτέλα **Resources** του Docker Desktop, μπορείτε να ρυθμίσετε τη χρήση πόρων όπως CPU, μνήμη (RAM) και δίσκο για το WSL backend.
