...
For my own test VM, the corresponding name was `Windows 11 Bigdata dsml 2026`, but that is not part of the general student workflow.
...
- the cluster server is `https://termi7.cslab.ece.ntua.gr:6443`
